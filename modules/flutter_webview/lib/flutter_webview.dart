 ...
 * @LastEditors: laijihua 1164258202@qq.com
 * @LastEditTime: 2024-10-30 16:38:08
 */
import 'dart:async';
...
class FlutterWebview {
  ...
  Future<bool?> navigate(String url, {String? script}) async {
    ...
    return _FlutterWebview.instance._channel.invokeMethod<bool>("navigate", arguments);
  }
...
class _FlutterWebview {
  ...
  _FlutterWebview._internal() {
    _channel.setMethodCallHandler((call) async {
      try {
        ...
        if (methodHandlers[engine] == null) return ;
        var ret = await methodHandlers[engine]!(call.method, args);
        if (ret is MethodHandlerNotImplement) return ;
        return ret;
      } catch (e) {
        print(e);
      }
  ...
  static _FlutterWebview _getInstance() {
    if (_instance == null) {
      _instance = _FlutterWebview._internal();
    }
    return _instance!;
  }
}
